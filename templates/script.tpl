...
sudo certbot certonly --standalone -d vault.maniakacademy.com -m sebastian@maniak.io --agree-tos --eff-email
...
export VAULT_ADDR="http://${vault_name}:8200"
